                ...
                <article className="resume-wrapper mx-auto theme-bg-light p-5 shadow-lg" id='pdf-content' style={{
                    ...
                    <div className="resume-intro py-3">
                        <div className="media flex-column flex-md-row align-items-center">
                            <img className="resume-profile-image mb-3 mb-md-0 mr-md-5 ml-md-0 rounded mx-auto" src="assets/images/khan_md_tanveer.jpg" style={{borderRadius : '50%'}} alt="image" />
                            <div className="media-body text-left">
                                <p className="mb-0">Since earning my Bachelor’s in Computer Science and Engineering in 2020, I immersed myself in coding
                                    and technology. My academic years laid a strong foundation in programming, driven by curiosity and a passion for innovation. Post-graduation, I quickly transitioned into an internship, applying my skills and evolving into an accomplished software developer. Known for rapid learning, adaptability, and delivering high-quality code, my dedication and collaborative spirit have earned me recognition from peers and mentors. </p>
                            </div>
                        </div>
                    </div>
                    <hr />
                                    ...
                                    <div className="item mb-3">
                                        ...
                                        <div className="item-content">
                                            ...
                                            >
                                                ...
                                                <li>Actively participated in code reviews and knowledge sharing sessions.</li>
                                                <li>Stayed updated on React.js and Django advancements for continuous improvement.</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="item mb-3">
                                        ...
                                        <div className="item-content">
                                            ...
                                            >
                                                ...
                                                <li>Experienced in participating in Agile ceremonies such as sprint planning, daily stand-ups, sprint reviews, and retrospectives to foster collaboration and transparency throughout the development process.</li>
                                                <li>Proven track record of delivering high-quality software solutions that meet or exceed client expectations, with a focus on scalability, performance, and maintainability.</li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div className="item mb-3">
                                        ...
                                        <div className="item-content">
                                            ...
                                            >
                                                ...
                                                <li>Strengthening knowledge in backend development with C# and Entity Framework Core</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="item">
                                ...
                                <section className="education-section py-3" style={{pageBreakInside : 'avoid'}} >
                                    ...
                                    <ul className="list-unstyled resume-awards-list">
                                        <li className="mb-3">
                                            ...
                                            <div className="text-muted">Integrify Academy (2024)</div>
                                        </li>
                                        {/* <li>
